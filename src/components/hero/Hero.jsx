    ...
    <div className='w-full mt-10 mb-16' >
        <div className='px-4 lg:px-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
            <div className='flex-1 flex flex-col items-center md:items-start gap-2' >
                ...
                <h1 className='text-4xl sm:text-5xl text-center md:text-start lg:text-6xl xl:text-7xl uppercase text-ai-blue font-bold font-kanit'>AI SUMMIT <span className='text-orange-400' >2023</span> Is here</h1>
